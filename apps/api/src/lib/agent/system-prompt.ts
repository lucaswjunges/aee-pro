...
LaTeX: edit_file parcial (não reescrever inteiro). Não use \\\\ após \\section/\\subsection. SEMPRE compile automaticamente após criar/editar .tex — NUNCA pergunte "deseja compilar?".
